...
<head>
    ...
    @component('meta')
        ...
        @endslot
    @endcomponent
    <link rel="stylesheet" href="{{ staticUrl('css/landing-2021-05.css', true) }}">
    ...
    <div class="wrapper">
        <section id="section-01" >
            ...
            <video id="intro" class="video-bg" preload="auto" loop muted autoplay playsinline
                poster="{{ staticUrl('images/landing-2021-05/section-01-bg.jpg') }}">
                <source src="{{ staticUrl('images/landing-2021-05/bg_frame_2021.mp4') }}" type="video/mp4">
            </video>
            ...
            <div class="info-server container">
                ...
                <div class="info-content">
                    <ul data-aos="zoom-in-left">
                        <li><span class="icon" ></span><p>Đã hoạt động <span>3 năm</span> cực kỳ ổn định</p></li>
                    ...
                    <ul data-aos="zoom-in-right">
                        ...
                        <li><span class="icon" ></span><p>Giới hạn tuyệt đối <span>4 account/PC</span> khi tham gia hoạt động</li>
                        <li><span class="icon" ></span><p>Giới hạn tuyệt đối <span>2 account/ PC/ IP</span> khi tham gia Tống Kim</li>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ staticUrl('js/landing-2021-05.js', true) }}"></script>
@show
