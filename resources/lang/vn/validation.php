...
return [
    ...
    */
    ...
    'accepted'             => 'Trườngf :attribute phải được chấp nhận.',
    ...
    'between'              => [
        ...
        'file'    => 'Dung lượng tập tin trong của :attribute phải từ :min - :max kB.',
        'string'  => 'Trường :attribute phải từ :min - :max ký tự.',
        'array'   => 'Trường :attribute phải có từ :min - :max phần tử.',
    ],
    'boolean'              => 'Trường :attribute phải là true hoặc false.',
    'confirmed'            => 'Giá trị xác nhận trong của :attribute không khớp.',
    'date'                 => 'Trường :attribute không phải là định dạng của ngày-tháng.',
    'date_equals'          => 'Trường :attribute phải là một ngày bằng với :date.',
    'date_format'          => 'Trường :attribute không giống với định dạng :format.',
    'different'            => 'Trường :attribute và :other phải khác nhau.',
    'digits'               => 'Độ dài của của :attribute phải gồm :digits chữ số.',
    'digits_between'       => 'Độ dài của của :attribute phải nằm trong khoảng :min and :max chữ số.',
    'dimensions'           => 'Trường :attribute có kích thước không hợp lệ.',
    'distinct'             => 'Trường :attribute có giá trị trùng lặp.',
    'email'                => 'Địa chỉ email không hợp lệ',
    'exists'               => 'Giá trị đã chọn trong của :attribute không hợp lệ.',
    'file'                 => 'Trường :attribute phải là một tệp tin.',
    'filled'               => 'Trường :attribute không được bỏ trống.',
    'gt'                   => [
        'numeric' => 'Giá trị của :attribute phải lớn hơn :value.',
        'file'    => 'Dung lượng của :attribute phải lớn hơn :value kilobytes.',
        'string'  => 'Độ dài của :attribute phải nhiều hơn :value kí tự.',
        'array'   => 'Mảng :attribute phải có nhiều hơn :value phần tử.',
    ],
    'gte'                  => [
        'numeric' => 'Giá trị của :attribute phải lớn hơn hoặc bằng :value.',
        'file'    => 'Dung lượng của :attribute phải lớn hơn hoặc bằng :value kilobytes.',
        'string'  => 'Độ dài của :attribute phải lớn hơn hoặc bằng :value kí tự.',
        'array'   => 'Mảng :attribute phải có ít nhất :value phần tử.',
    ],
    'image'                => 'Trường :attribute phải là định dạng hình ảnh.',
    'in'                   => 'Giá trị đã chọn trong của :attribute không hợp lệ.',
    ...
    'lt'                   => [
        'numeric' => 'Giá trị của :attribute phải nhỏ hơn :value.',
        'file'    => 'Dung lượng của :attribute phải nhỏ hơn :value kilobytes.',
        'string'  => 'Độ dài của :attribute phải nhỏ hơn :value kí tự.',
        'array'   => 'Mảng :attribute phải có ít hơn :value phần tử.',
    ],
    'lte'                  => [
        'numeric' => 'Giá trị của :attribute phải nhỏ hơn hoặc bằng :value.',
        'file'    => 'Dung lượng của :attribute phải nhỏ hơn hoặc bằng :value kilobytes.',
        'string'  => 'Độ dài của :attribute phải nhỏ hơn hoặc bằng :value kí tự.',
        'array'   => 'Mảng :attribute không được có nhiều hơn :value phần tử.',
    ],
    'max'                  => [
        'numeric' => 'Trường :attribute không được lớn hơn :max.',
        'file'    => 'Dung lượng tập tin trong của :attribute không được lớn hơn :max kB.',
    ...
    'min'                  => [
        ...
        'file'    => 'Dung lượng tập tin trong của :attribute phải tối thiểu :min kB.',
        'string'  => 'Trường :attribute phải có tối thiểu :min ký tự.',
        'array'   => 'Trường :attribute phải có tối thiểu :min phần tử.',
    ],
    'not_in'               => 'Giá trị đã chọn trong của :attribute không hợp lệ.',
    ...
    'required_if'          => 'Trường :attribute không được bỏ trống khi của :other là :value.',
    ...
    'size'                 => [
        ...
        'file'    => 'Dung lượng tập tin trong của :attribute phải bằng :size kB.',
