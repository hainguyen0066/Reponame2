...
mix.copyDirectory('resources/images', 'public/images')
    ...
    .copyDirectory('resources/js/launcher', 'public/js/launcher')
    ...
    .sass('resources/sass/slick.scss', 'public/css/slick.css')
    .sass('resources/sass/slick-theme.scss', 'public/css/slick-theme.css')
    .options({
