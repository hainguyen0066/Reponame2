 ...
 * Generated for Laravel 7.23.0 on 2021-06-02 17:48:16.
 *
...
namespace TCG\Voyager\Facades { 
    ...
    class Voyager {
         ...
         * @param $fieldName
         * @return \TCG\Voyager\DataRow 
         * @throws \Exception
         * @static 
         */ 
        public static function getField($dataTypeRows, $fieldName)
        {
                        /** @var \TCG\Voyager\Voyager $instance */
                        return $instance->getField($dataTypeRows, $fieldName);
        }
         ...
         * @static 
         */ 
        public static function formWidget($row, $dataType, $dataTypeContent, $withLabel = true)
        {
                        /** @var \TCG\Voyager\Voyager $instance */
                        return $instance->formWidget($row, $dataType, $dataTypeContent, $withLabel);
        }
         ...
         * @static 
         */ 
        public static function formLabel($dataRow)
        {
                        /** @var \TCG\Voyager\Voyager $instance */
                        return $instance->formLabel($dataRow);
        }
        ...
        {
                        /** @var \TCG\Voyager\Voyager $instance */
                        return $instance->displayField($dataType, $row, $data);
        }
        ...
        {
                        /** @var \TCG\Voyager\Voyager $instance */
                        return $instance->getBreadView($view, $slug);
        }
