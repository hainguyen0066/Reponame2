 ...
 * Generated for Laravel 5.7.3 on 2020-05-27 16:07:12.
 *
...
namespace TCG\Voyager\Facades { 
    ...
    class Voyager {
        ...
        {
            return \TCG\Voyager\Voyager::getField($dataTypeRows, $fieldName);
        }
        ...
        {
            return \TCG\Voyager\Voyager::formWidget($row, $dataType, $dataTypeContent, $withLabel);
        }
        ...
        {
            return \TCG\Voyager\Voyager::formLabel($dataRow);
        }
